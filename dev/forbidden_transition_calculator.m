...
He_spectrum.wavelength = ones((numel(He_data.Level_eV)-1),1);
...
%     He_spectrum.wavelength(3*ii-3) = eV_to_wavelength(eV_current,eV_2_3P1);
    ...
    He_spectrum.wavelength(ii-1) = eV_to_wavelength(eV_current,eV_2_3P2);
    He_spectrum.transition{ii-1} = strcat(['2_3P2 -> ',level_current]);
